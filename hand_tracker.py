...
# Tracks the state for single-press reliability
gesture_state = {
    'move_left': False,
    'move_right': False,
    'jump': False,
...
# --- Key Press Helper (Pynput) ---
def press_and_release(key_code):
    """Simulates a quick press and release of a key using pynput."""
...
def count_extended_fingers(landmarks):
    ...
    # Thumb check (Index 0): Tip Y < MCP Y means extended upwards
    ...
    for i in range(1, 5): 
        ...
        # If TIP_Y is smaller than PIP_Y, the finger is extended
...
while cap.isOpened():
    ...
    # Get image dimensions once here
    h, w, c = image.shape 
    ...
    # Temporarily store active checks
    current_action = {
        'move_left': False,
        'move_right': False,
        'jump': False,
    ...
    if results.multi_hand_landmarks:
        ...
        # ===============================================
        # | 1. HORIZONTAL LANE CHECK (Always checked)     |
        # ===============================================
        ...
        # ===============================================
        # | 2. VERTICAL GESTURE CHECK (Always checked)    |
        # ===============================================
        ...
        # DUCK/DOWN (Hang Loose)
        elif extended[0] and extended[4] and not extended[1] and not extended[2] and not extended[3]:
            current_action['duck'] = True
            
            
    # ===============================================
    # | 3. STATE CHECK AND KEY PRESS EXECUTION        |
    # |    (Horizontal takes logical priority in ELIF) |
    # ===============================================

    # --- HORIZONTAL PRIORITY CHECK ---
    ...
    # ===============================================
    # | 4. DRAW LANE BOUNDARY LINES (NEW)             |
    # ===============================================
    
    # Calculate pixel positions for the normalized boundaries
    left_line_x = int(LEFT_LANE_BOUND * w)
    right_line_x = int(RIGHT_LANE_BOUND * w)
    
    # Draw Left Boundary Line (Red)
    cv2.line(image, (left_line_x, 0), (left_line_x, h), (0, 0, 255), 2)
    
    # Draw Right Boundary Line (Red)
    cv2.line(image, (right_line_x, 0), (right_line_x, h), (0, 0, 255), 2)
